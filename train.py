...
def parse_args() -> argparse.Namespace:
    ...
    # Paired (int, dense) weighted pooling. This branch (exp/paired-62-66)
    # restricts paired pooling to fids 62-66 ONLY (5 of the 8 documented
    # aligned columns). Fids 89-91 fall back to baseline mean pool.
    parser.add_argument('--paired_pool_fids', type=str,
                        ...
                        help='Comma-separated user_int / user_dense fids whose '
                             ...
                             'only 62-66. Pass an empty string to fall back to '
